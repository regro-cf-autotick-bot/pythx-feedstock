...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pythx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12480&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pythx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pythx` can be installed with:

```
conda install pythx
```

It is possible to list all of the versions of `pythx` available on your platform with:
